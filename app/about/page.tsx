    ...
    return (
        <div className="md:h-[80vh] flex items-center justify-center flex-col-reverse md:flex-row-reverse space-y-5 md:space-y-0">
            <section className="md:w-2/3 space-y-2 md:space-y-5 md:text-left text-center flex flex-col items-center md:items-start">
                ...
                <div className="flex flex-col w-full items-center lg:flex-row gap-3 lg:mt-10">
                    <Link className="w-full" href="/skills"><Btn className="w-full">My Skills</Btn></Link>
                    <Link className="w-full" href="/projects"><Btn className="w-full">My Projects</Btn></Link>
                    <Link className="w-full" href="/contact"><Btn className="w-full">Contact Me</Btn></Link>
                </div>
            </section>
